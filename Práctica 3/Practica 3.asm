...
RETLW B'00111111'	;Retorna si PCL = .0
RETLW B'00000110'	;Retorna si PCL = .1
RETLW B'01011011'	;Retorna si PCL = .2
RETLW B'01001111'	;Retorna si PCL = .3
RETLW B'01100110'	;Retorna si PCL = .4
RETLW B'01101101'	;Retorna si PCL = .5
RETLW B'01111101'	;Retorna si PCL = .6
RETLW B'00000111'	;Retorna si PCL = .7
